...
/**
 * Sends Form data to the BotlyStudioServer using Ajax.
...
/**
 * Sends plain data to the BotlyStudioServer using Ajax.
...
/**
 * Gets the current Compiler location from the BotlyStudioServer settings.
 ...
 */
BotlyStudioServer.requestCompilerLocation = function(callback) {
   BotlyStudioServer.ajaxPostForm(
 ...
 *                             an HTML element of type input text.
 */
BotlyStudioServer.requestNewCompilerLocation = function(callback) {
 ...
 *                             an HTML element of type input text.
 */
BotlyStudioServer.requestSketchLocation = function(callback) {
   BotlyStudioServer.ajaxPostForm(
      'ArduServerCompilerSettings.html',
      'sketch=get',
      callback);
 ...
 */
BotlyStudioServer.requestNewSketchLocation = function(callback) {
  console.log("Openning explorer ...");
  BotlyStudioServer.ajaxPostForm(
      'ArduServerCompilerSettings.html',
      'sketch=set',
 ...
 */
BotlyStudioServer.requestArduinoBoards = function(callback) {
  BotlyStudioServer.ajaxPostForm(
      'ArduServerCompilerSettings.html',
      'board=get',
      callback);
 ...
 *                             an HTML select element.
 */
BotlyStudioServer.setArduinoBoard = function(new_board, callback) {
  BotlyStudioServer.ajaxPostForm(
      'ArduServerCompilerSettings.html',
 ...
 *                             an HTML select element.
 */
BotlyStudioServer.requestSerialPorts = function(callback) {
  BotlyStudioServer.ajaxPostForm(
      'ArduServerCompilerSettings.html',
      'serial=get',
      callback);
 ...
 *                             an HTML select element.
 */
BotlyStudioServer.setSerialPort = function(new_port, callback) {
  BotlyStudioServer.ajaxPostForm(
      'ArduServerCompilerSettings.html',
 ...
 *                             an HTML select element.
 */
BotlyStudioServer.requestIdeOptions = function(callback) {
  BotlyStudioServer.ajaxPostForm(
      'ArduServerCompilerSettings.html',
      'ide=get',
      callback);
 ...
 *                             an HTML select element.
 */
BotlyStudioServer.setIdeOptions = function(ide_option, callback) {
  BotlyStudioServer.ajaxPostForm(
      'ArduServerCompilerSettings.html',
...
/**
 * Sends the Arduino code to the BotlyStudioServer to be processed as defined
 * by the settings.
 ...
 *                             an HTML select element.
 */
BotlyStudioServer.sendSketchToServer = function(code, callback) {
  BotlyStudioServer.ajaxPostPlain(
      'SendSketch.html',
      code,
      callback);
};
